...
export type GetProductsQuery = {
    __typename?: "Query";
    products?: Array<{ __typename?: "Product"; id: number; name: string; description: string } | null> | null;
};
...
export type GetProductVariantQuery = {
    ...
    productVariant?: {
        ...
        name: string;
        description: string;
        items?: Array<{ __typename?: "InventoryItem"; id: number; inventoryState: InventoryState } | null> | null;
    } | null;
};
...
export type CreateProductMutation = {
    __typename?: "Mutation";
    createProduct?: { __typename?: "Product"; id: number; name: string; description: string } | null;
};
...
export type CreateProductVariantMutation = {
    __typename?: "Mutation";
    createProductVariant?: { __typename?: "ProductVariant"; id: number; name: string; description: string } | null;
};
...
export type CreateInventoryItemMutation = {
    __typename?: "Mutation";
    createInventoryItem?: { __typename?: "InventoryItem"; id: number; inventoryState: InventoryState } | null;
};

export type ProductInfoFragment = { __typename?: "Product"; id: number; name: string; description: string };

export type ProductVariantInfoFragment = {
    __typename?: "ProductVariant";
    id: number;
    name: string;
    description: string;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        ...
        getProductVariant(
            variables: GetProductVariantQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<GetProductVariantQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<GetProductVariantQuery>(GetProductVariantDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders
                    }),
                "getProductVariant",
        ...
        createProductVariant(
            ...
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<CreateProductVariantMutation>(CreateProductVariantDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders
                    }),
                "createProductVariant",
        ...
        createInventoryItem(
            ...
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<CreateInventoryItemMutation>(CreateInventoryItemDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders
                    }),
                "createInventoryItem",
